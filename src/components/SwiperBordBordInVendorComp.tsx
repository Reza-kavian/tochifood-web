                                ...
                                <div className="contInSlide" style={{
                                    ...
                                    <button
                                        ...
                                        style={{
                                            ...
                                            backgroundColor: (activeTab == item.IdG1.toString() ? '#f1f2f3' : 'white')  ////zare_nk_050405_added
                                        }}>
                                        <div style={{
                            ...
                            <button
                                ...
                                <div style={{
                                    ...
                                    <div style={{
                                        ...
                                        <div style={{
                                            ...
                                            <div style={{
                                                ...
                                                با خرید حداقل ۲۰۰٬۰۰۰ تومان در سفارش اول + پرداخت از درگاه آنلاین
                                            </div>
                                        </div>
                                        <div style={{
                                            display: 'flex',
                                    ...
                                    <div style={{
                                        ...
                                        <div style={{
                                            display: 'flex', justifyContent: 'center', alignItems: 'center', height: '1.5rem', width: '1.5rem',
                                        }}>
                                            <img
                                                src="/images/movaghat/vendorPage/motor-peyk.svg"
                                                alt="موتورپیک"
                                            // style={{ width: '1rem', height: '1rem', }}
                                            />
                                        </div>
                                    ...
                                    <div style={{
                                        ...
                                        <div style={{
                                            ...
                                            <div style={{
                                                ...
                                                با خرید حداقل 7۰۰٬۰۰۰ تومان در سفارش اول + پرداخت از درگاه آنلاین
                                            </div>
                                        </div>
                                        <div style={{
                                            display: 'flex',
...
export default memo(SwiperBordBordInVendorComp); 