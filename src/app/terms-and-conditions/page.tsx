            ...
            <div style={{ width: '100%', display: "flex", flexDirection: 'column', paddingBottom: '2rem', }}>
              <div style={{ width: '100%', display: "flex", flexDirection: 'column', }}>
                <h2 style={{ color: '#313335', fontSize: '1.25rem', lineHeight: '1.75rem', margin: '0px' }}>
                  شرایط اختصاصی استفاده از خدمات تپسی در حوزه سفارش غذا برای مشتری
                </h2>

                <p style={{ color: '#63676e', fontSize: '1rem', lineHeight: '1.75rem', margin: '0px', marginTop: '1rem', }}>
                  این شرایط به‌عنوان ضوابط اختصاصی حاکم بر استفاده از خدمات تپسی در حوزه سفارش غذا برای مشتری (از این پس «شرایط استفاده اختصاصی مشتری») در کنار «شرایط عمومی استفاده از سوپراپلیکیشن تپسی»، مجموعا شرایط استفاده از تپسی‌فود را تشکیل داده و از این رو مشتری با اطلاع و آگاهی از این شرایط نسبت به درخواست سفارش غذا اقدام می‌کند.
                </p>
              ...
              <div style={{ width: '100%', display: "flex", flexDirection: 'column', marginTop: '1.5rem', }}>
                ...
                <div style={{ width: '100%', display: "flex", flexDirection: 'column', marginTop: '1rem', }}>
                  ...
                  <p style={{ color: '#63676e', fontSize: '1rem', lineHeight: '1.75rem', margin: '0px', marginTop: '1rem', }}>
                    <strong style={{marginLeft:'5px',}}>ب) تپسی‌فود:</strong>
                  ...
                  <p style={{ color: '#63676e', fontSize: '1rem', lineHeight: '1.75rem', margin: '0px', marginTop: '1rem', }}>
                    ...
                    متقاضی استفاده از سرویس تپسی‌فود است که با ایجاد حساب کاربری در سوپراپ و رعایت شرایط اختصاصی مشتری، نسبت به ثبت درخواست خرید محصولات غذایی از یک یا چند فروشگاه و حسب مورد درخواست ارسال آن به مقصد تعیین‌شده اقدام می‌کند.
                  </p>
