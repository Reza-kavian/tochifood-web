...
export default function CartDetails() {
    ...
    const refForfather = useRef<string | null>(null);  ////zare_nk_050416_added(dar sabade food karbord nadareh,baraye marja boodane componente MiddleCountTedadSefr gozashtam)
